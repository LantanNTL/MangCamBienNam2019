...
def publish_Fake_Sensors_Values_to_MQTT():
	...
	Rain_Fake_Value = int(random.uniform(0,1))
	a = [1,2,3,4]
	b = [1,2,3,4]
	status = ['mua_nhe','mua_phun','mua_rao','mua_bao']	
	i = random.randint(0,3)
	j = random.randint(0,3)
	Long_Fake_Value = a[i]
	Lat_Fake_Value = b[i]
	Rainweather_Fake_Value = status[j] 
	#=====================================================
	Sensor_data = {}
	Sensor_data['Sensor_ID'] = "DHT11"
	Sensor_data['Long_id'] = Long_Fake_Value
	Sensor_data['Lat'] = Lat_Fake_Value
	...
	Sensor_data['Rain'] = Rain_Fake_Value
	Sensor_data['Rainweather'] = Rainweather_Fake_Value
