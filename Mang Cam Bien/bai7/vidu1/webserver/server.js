...
io.on('connection', function(socket) {
  ...
  client.on('message', function (topic, message) {
    ...
    if(temp != data.Temperature || hum!=data.Humidity || wind != data.Windspeed)
    {
    ...
    let sql = "INSERT INTO sensors (Date_and_Time, Temperature, Humidity, Windspeed, W_status) VALUES ('"+time+"','"+temp+"','"+hum+"','"+wind+"','"+status+"');"
